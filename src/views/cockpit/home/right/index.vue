<template>
  <div class="box1">
    ...
    <div v-for="(item, index) in list" :key="index">
      <div class="header-box" :class="headerStyle[index]">
        <img :src="item.headerBackImg" alt="" />
      ...
      <div class="content-box">
        <ul v-for="(item1, index) in item.imgList" :key="index">
          <li>
  ...
  data() {
    return {
      list: [
        {
          headerTitle: "特色产业",
          headerBackImg: require('../../../../assets/cockpit/public/具体内容标题背景.png'),
          imgList: [
        ...
        },
        {
          ...
          headerBackImg: require('../../../../assets/cockpit/public/具体内容标题背景.png'),
          imgList: [
            {url:require('../../../../assets/cockpit/示例图片/11.jpg')},
