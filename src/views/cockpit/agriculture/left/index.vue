<template>
  <div class="box1">
    ...
    <!-- 标题盒子2 -->
    <div class="header-box" style="margin-top: -5vh">
      <img
        src="@/assets/cockpit/public/具体内容标题背景.png"
        alt=""
        class="left-content2"
    ...
    <div class="content-box">
      ...
      <div
        class="list-box"
        v-for="item in salesList.slice(0, 8)"
        :key="item.index"
      >
        <div class="restore">
          <div class="list-index-box">
            <img :src="item.indexBackImg" alt="" />
            <span class="list-index"> NO.{{ item.index + 1 }} </span>
          </div>
...
export default {
      ...
      salesList: [
        {
          ...
          productName: "水果",
          salesVolume: 15680,
          indexBackImg: require("../../../../assets/cockpit/agriculture/左三NO.1.png"),
        },
        {
          index: 1,
          productName: "蔬菜",
          salesVolume: 14378,
          indexBackImg: require("../../../../assets/cockpit/agriculture/左三NO.2.png"),
        },
        {
          index: 2,
          productName: "粮食",
          salesVolume: 13280,
          indexBackImg: require("../../../../assets/cockpit/agriculture/左三NO.3.png"),
        },
        {
          index: 3,
          productName: "水果",
          salesVolume: 12890,
          indexBackImg: require("../../../../assets/cockpit/agriculture/左三NO.4.png"),
        },
        {
          index: 4,
          productName: "蔬菜",
    ...
    displayEcharts1() {
      ...
      function getPie3D(pieData, internalDiameterRatio) {
        ...
        for (let i = 0; i < series.length; i++) {
          ...
          let endPosArr = [
            posX * 1.8 + i * 0.1 * flag + (flag < 0 ? -1 : 0),
            posY * 2.5 + i * 0.1 * flag + (flag < 0 ? -1 : 0),
            posZ * 10,
          ];
          linesSeries.push(
            {
            ...
            },
            {
              ...
              data: [
                {
                  name: series[i].name + "/n" + series[i].pieData.value,
                  value: endPosArr,
                },
              ],
            }
    ...
    displayEcharts2() {
      ...
      let option = {
        ...
        series: [
          ...
          {
            name: "预测耗能",
            data: [0.27, 0.37, 0.3, 0.17, 0.27, 0.2, 0.35],
            type: "line",
            areaStyle: {
              opacity: 0.1,
              color: "#03DAFD",
  ...
  mounted() {
    this.displayEcharts1(), this.displayEcharts2();
  },
};
</script>
